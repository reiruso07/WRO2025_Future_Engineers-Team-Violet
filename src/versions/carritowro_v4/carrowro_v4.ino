...
void loop() {
 ...
 /* Serial.print("sensor derecha");
  ...
  if((redValue>=240&&redValue<=265&&greenValue>=210&&greenValue<=230&&blueValue>=210&&blueValue<=230&&lineader==0&&lineaizq==0)||cruzlineader==1){
    ...
    if((blueValue>=191&&blueValue<=240&&redValue>=178&&redValue<=225&&greenValue>=170&&greenValue<=233&&lineader==0&&lineaizq==0)||cruzlineaizq==1){
    if(cont-valoranteslinea>intervalolinea){
      valoranteslinea=cont;
    ...
    if((blueValue>=191&&blueValue<=240&&redValue>=178&&redValue<=225&&greenValue>=170&&greenValue<=233&&lineaizq==1&&lineas<12)||cruzlineaizq2==1){
    if(cont-valoranteslinea>intervalolinea){
      valoranteslinea=cont;
      Serial.println("linea azul detectada");
      Serial.println(lineas);
    ...
    if((blueValue>=191&&blueValue<=240&&redValue>=178&&redValue<=225&&greenValue>=170&&greenValue<=233&&lineaizq==1&&lineas==12)||cruzlineaizq3==1){
    if(cont-valoranteslinea>intervalolinea){
      valoranteslinea=cont;
      Serial.println("linea azul detectada");
      Serial.println(lineas);
