...
>- Spline Internal Thread Depth: 6mm
  ...
  -   **Arduino Mega 2560**: Located in the middle module, it is used to manage the robot's mobility alongside the L298N Motor Driver, thus allowing the robot to move freely on a flat surface.
